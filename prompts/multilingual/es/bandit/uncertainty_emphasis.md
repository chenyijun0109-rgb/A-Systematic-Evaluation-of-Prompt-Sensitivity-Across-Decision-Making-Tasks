...
conoces de antemano. Cada recompensa observada aporta solo información parcial
sobre esos patrones. Después de cada elección, se te muestra la recompensa de la
opción seleccionada. En elecciones posteriores, puedes utilizar esta información
incompleta y el número de elecciones restantes en el juego actual.
