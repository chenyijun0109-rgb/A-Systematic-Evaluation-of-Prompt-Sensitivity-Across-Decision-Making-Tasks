...
Publication figures are available in the repository's top-level
\url{figures/} directory. They support inspection of cells omitted from the
necessarily selective Results prose. The principal findings, methodological
contribution, and evidence needed to assess the dissertation's conclusions
